...
The application has been written using C++ using the Visual Studio 2012%% IDE.
This application has been built upon a free tutorial framework called Raster Tek, %%.
As well as using C++ and the Raster Tek framework Nvidia’s CUDA %% general-purpose GPU computing language will be used to simulate the growth and dissipation of the clouds in real time.
